...
import com.sethah.spark.sparkopt.ml.optim.loss.{GLMLoss, L2Regularization}
import com.sethah.spark.sparkopt.ml.optim.minimizers.LBFGS
...
object GLMExample {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val indexToReg = (idx: Int) => if (idx >= 0 && idx < numFeatures) params.l2Reg else 0.0
    val l2Reg = new L2Regularization(indexToReg)
